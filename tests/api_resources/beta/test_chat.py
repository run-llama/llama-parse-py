...
class TestChat:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_set_title(self, client: LlamaCloud) -> None:
        chat = client.beta.chat.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
        )
        assert_matches_type(ChatSetTitleResponse, chat, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_set_title_with_all_params(self, client: LlamaCloud) -> None:
        chat = client.beta.chat.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_set_title(self, client: LlamaCloud) -> None:
        response = client.beta.chat.with_raw_response.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_set_title(self, client: LlamaCloud) -> None:
        with client.beta.chat.with_streaming_response.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_set_title(self, client: LlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            client.beta.chat.with_raw_response.set_title(
                session_id="",
                first_message="What were the main findings in Q3?",
            )
...
class TestAsyncChat:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_set_title(self, async_client: AsyncLlamaCloud) -> None:
        chat = await async_client.beta.chat.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
        )
        assert_matches_type(ChatSetTitleResponse, chat, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_set_title_with_all_params(self, async_client: AsyncLlamaCloud) -> None:
        chat = await async_client.beta.chat.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_set_title(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.beta.chat.with_raw_response.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_set_title(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.beta.chat.with_streaming_response.set_title(
            session_id="session_id",
            first_message="What were the main findings in Q3?",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_set_title(self, async_client: AsyncLlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            await async_client.beta.chat.with_raw_response.set_title(
                session_id="",
                first_message="What were the main findings in Q3?",
            )
