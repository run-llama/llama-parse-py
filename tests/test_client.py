...
class TestLlamaCloud:
    ...
    def test_hardcoded_query_params_in_url(self, client: LlamaCloud) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: LlamaCloud) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: LlamaCloud) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
...
class TestAsyncLlamaCloud:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncLlamaCloud) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncLlamaCloud) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
