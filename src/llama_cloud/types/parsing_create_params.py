...
class ParsingCreateParams(TypedDict, total=False):
    ...
    version: Required[Union[Literal["latest", "2026-07-24", "2026-07-23", "2026-07-08", "2026-06-15"], str]]
...
class ProcessingOptionsAutoModeConfigurationParsingConf(TypedDict, total=False):
    ...
    version: Union[Literal["latest", "2026-07-24", "2026-07-23", "2026-07-08", "2026-06-15"], str, None]
