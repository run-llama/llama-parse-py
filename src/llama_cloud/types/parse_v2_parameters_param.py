...
class ProcessingOptionsAutoModeConfigurationParsingConf(TypedDict, total=False):
    ...
    version: Union[Literal["latest", "2026-08-19", "2026-08-11", "2026-07-08", "2026-06-15"], str, None]
...
class ParseV2ParametersParam(TypedDict, total=False):
    ...
    version: Required[Union[Literal["latest", "2026-08-19", "2026-08-11", "2026-07-08", "2026-06-15"], str]]
